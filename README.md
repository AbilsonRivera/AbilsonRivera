<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:1f6feb&height=220&section=header&text=Abilson%20Rivera%20García&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Senior%20Full%20Stack%20Developer%20%7C%20Java%20%E2%80%A2%20Spring%20Boot%20%E2%80%A2%20Next.js&descSize=16&descAlignY=55&descAlign=50"/>

<div align="center">

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=58A6FF&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=70&lines=Senior+Full+Stack+Developer+%F0%9F%9A%80;Java+%E2%80%A2+Spring+Boot+%E2%80%A2+Next.js+%E2%80%A2+MySQL)](https://git.io/typing-svg)
...
rol_actual: Senior Full Stack Developer @ Grupo Hay Plan
educación: Ingeniería de Software — FET (en curso)
enfoque: Aplicaciones web escalables con Java/Spring Boot + Next.js
```

- 🔭 &nbsp;Actualmente trabajo como **Senior Full Stack Developer** en **Grupo Hay Plan**
- ⚙️ &nbsp;Backend con **Java, Spring Boot, APIs REST, JWT, MySQL**
- 🎨 &nbsp;Frontend con **Next.js (React), Tailwind CSS, componentes responsivos**
- 🎓 &nbsp;Cursando **Ingeniería de Software** en la FET, Neiva
